export default function Card({ emoji, heading, text }) {
    return (
        <section className="border-[1px] border-black lg:h-[460px] h-[360px] lg:w-[413px] w-[313px] rounded-[20px] md:rounded-[30px] flex justify-center items-center text-[#333232]">
