export default function Hero() {
    return (
        <section className="lg:w-[890px] my-20 md:w-[650px] w-screen h-fit m-auto text-[#333232] relative">
            ...
            <div className="md:absolute lg:top-[30%] md:top-[25%] lg:w-[240px] lg:text-[16px] md:right-0 md:w-[250px] md:px-0 md:text-start md:mt-0 mt-4 px-[20%] text-center text-[14px] font-[400] leading-normal">
